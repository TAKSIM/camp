...
class Desktop(QtGui.QMainWindow):
    ...
    def createPages(self):
        ...
        layout_subdetails.addWidget(self.newsub, 0, 1, 1, 1)
        layout_subdetails.addWidget(QtGui.QLabel(u'筛选列'), 0, 2, 1, 1)
        layout_subdetails.addWidget(self.lvs.sortCol, 0, 3, 1, 1)
        layout_subdetails.addWidget(QtGui.QLabel(u'列包含'), 0, 4, 1, 1)
        layout_subdetails.addWidget(self.lvs.sortContent, 0, 5, 1, 1)
        layout_subdetails.addWidget(self.lvs.vb, 1, 0, 1, 6)
